...
def update_worksheet(sheet_name, data):
    """
    Update provided worksheet, add new row with the list data provided.
    """
...
def calculate_surplus_data(sales_row):
    ...
    stock_row = validate_data(stock_sheet.get_all_values().pop())
